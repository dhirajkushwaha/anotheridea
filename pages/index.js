		...
		<div data-scroll-container>
			...
			<section className="homeHeadSection">
				<div className="vimeo-fullscreen">
					...
					>
						{/* <iframe
							src="https://player.vimeo.com/video/347119375?h=a297e390d4&amp;title=0&amp;portrait=0&amp;muted=1&amp;autoplay=1&amp;controls=0&amp;dnt=1&amp;loop=1&amp;transparent=0&amp;background=1&amp;quality=240p&amp;app_id=122963"
							width="640"
							height="360"
							frameBorder="0"
			...
			<section className="bottomSection">
				<div className="footerLearnMore">
					...
					<p className="onlyDesk">
						...
						<br />
						We are passionate about crafting stories and bringing your brand to
						life.
						<br />
						Hence, we put collaboration at the center of our processes, so we
						can do what we love most:
						<br />
						Bring out the spirit of the human experience, set emotion to rhythm,
						and elevate drama you
						<br />
						cannot look away from.
					</p>

					<p className="onlyMob">
						A full-service production house based in Mumbai, India. We are
						passionate about crafting stories and bringing your brand to life.
						Hence, we put collaboration at the center of our processes, so we
						can do what we love most: Bring out the spirit of the human
